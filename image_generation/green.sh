#!/bin/bash
(CUDA_VISIBLE_DEVICES=0 blender --background --python render_images.py -- --num_images 5 --min_dist 0.25 --min_pixels_per_object 450 \
...
(
CUDA_VISIBLE_DEVICES=1 blender --background --python render_images.py -- --num_images 5 --min_dist 0.25 --min_pixels_per_object 450 \
...
(
CUDA_VISIBLE_DEVICES=2 blender --background --python render_images.py -- --num_images 5 --min_dist 0.25 --min_pixels_per_object 450 \
